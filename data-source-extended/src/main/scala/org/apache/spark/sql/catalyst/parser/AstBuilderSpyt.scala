...
import tech.ytsaurus.spyt.patch.annotations.{Decorate, DecoratedMethod, OriginClass, Subclass}
...
object AstBuilderSpyt {
  def extractUint64Opt(ctx: SqlBaseParser.PrimitiveDataTypeContext): Option[UInt64Type] = withOrigin(ctx) {
